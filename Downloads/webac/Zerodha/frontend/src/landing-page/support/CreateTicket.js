  ...
  return (
    <div className="container">
      <div className="row  mt-5 mb-3">
        <h1 className="text-muted fs-4 text-left ">
          To create a ticket, select a relevant topic
        </h1>
      </div>

      {/* Row that contains all three columns side by side */}
      <div className="row">
        ...
        <div className="col-4 p-4">
          <h4>
            <i class="fa-solid fa-barcode"></i> Kite
          </h4>
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
            IPO
          </a>
        ...
        <div className="row">
          <div className="col-4 p-4">
            <h4>
              <i class="fa-solid fa-pager"></i> Funds
            </h4>
            <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
              Add money
            </a>
